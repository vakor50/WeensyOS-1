 ...
 *   Create a new thread that begins by executing start_function
 *   returns: -1 if fails, pid of the of new process, 0 to new thread
 *
 *****************************************************************************/
...
sys_newthread(void (*start_function)(void))
{
  ...
  // instead of starting at same instruction as parent, run start_function
...
/*****************************************************************************
 * sys_kill(pid_t pid)
 *   allows one process to make another process exit
